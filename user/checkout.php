<?php 
    ...
    if(count($cart)>0){
        ...
        // $tgl_harus_kembali=time()+60;
        mysqli_query($conn,"insert into peminjaman_buku (id_siswa,tanggal_pinjam,tanggal_kembali) value('".$_SESSION['id_siswa']."','".date('Y-m-d')."','".$tgl_harus_bayar."')");
